...
interface CommunityRepository {
    ...
    suspend fun deleteCommunity(communityId: String): Results<Unit, DataError.Network>
    suspend fun editCommunity(community: Community): Results<Unit, DataError.Network>
}