...
interface CalendarRemoteDataSource {
    fun getUserEvents(request: CalendarRequest.GetUserEvents): Flow<Result<List<CalendarEvent>>>
    suspend fun createUserEvent(request: CalendarRequest.CreateEvent): Result<Nothing>
}