...
import com.gp.socialapp.presentation.assignment.submissions_screen.SubmissionsScreenModel
...
import com.gp.socialapp.presentation.chat.createchat.CreateChatScreenModel
...
val screenModelModuleK = DI.Module("screenModelModule") {
    ...
    bind<CreateChatScreenModel>() with singleton {
    ...
    bind<MaterialScreenModel>() with singleton { MaterialScreenModel(instance(), instance(), instance()) }
